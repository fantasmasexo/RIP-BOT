...
client.sendMessage(from, { audio: { url: response.url }, mimetype: 'audio/mpeg' });
  ...
  *╰────────────*
  \n*🔥${nomeBot}🔥*`
          ...
          case "tiktokvd": {
    if (q < 1) return reply("coloque o link do vídeo depois do comando");
  ...
  ╠🍉➽${prefix}Play_audio (nome da musica)
  ╠🍉➽${prefix}Play_video (nome do video)
  ║
  ╚════• 〘${nomeBot}〙•═════╝
  `,
              footer: `  `,
...
║
╚════• 〘${nomeBot}〙•═════╝
👑 Entre em contato: https://instagram.com/fantasmin.dev
`,
    footer: `🍉${nomeBot}🍉`,
  //  buttons: buttons,
    headerType: 4
